...
const base = {
  ...
  trendData: [], narrative: { globalSummary: '', vibeCheck: '', community: '', trendMomentum: '', demandSignals: '', anomaly: '', spamExclusionRate: '', kpi: '', topKeywords: [] }, collaboration: [],
  ...
  setKeyword: vi.fn(), setTimeRange: vi.fn(), setTargetBrandId: vi.fn(), runSearch: vi.fn(), loadRun: vi.fn(), cancelRun: vi.fn(),
};
