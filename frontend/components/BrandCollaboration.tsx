...
const mockCollaborations = [
  ...
  { id: 3, name: 'RedBull x Valorant', match: 91, audiences: 'Overlap: 80%', type: 'F&B Esports', color: 'bg-indigo-500' },
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <Card className="col-span-1 lg:col-span-2 bg-[#0c0c0e] border-[#1f1f22]">
          ...
          <CardContent className="h-[400px] flex items-center justify-center border border-dashed border-[#1f1f22] rounded-lg bg-[#050505] m-6 mt-0 relative overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-48 border-t-2 border-dashed border-blue-400/50 flex justify-center">
              <div className="bg-[#0c0c0e] px-2 py-1 -mt-3 text-[10px] font-bold text-white border border-[#1f1f22] rounded-md flex items-center gap-1">
        ...
        <Card className="col-span-1 bg-[#0c0c0e] border-[#1f1f22]">
          ...
          <CardContent className="space-y-4">
            {mockCollaborations.map((collab) => (
              <div key={collab.id} className="p-4 rounded-xl border border-[#1f1f22] bg-[#141418] hover:bg-[#1a1a1f] transition-colors group cursor-pointer">
