    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="flex flex-col gap-4 pt-6">
        <div className="text-center space-y-4">
          <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-purple-500/10 border border-purple-500/20">
      ...
      <Card className="bg-[#0c0c0e] border-[#1f1f22] overflow-hidden mt-8 shadow-2xl">
        <CardContent className="p-0">
          <div className="p-6 border-b border-[#1f1f22] bg-[#050505]">
            <div className="relative">
              ...
              <Input
                ...
                className="h-16 pl-12 text-lg bg-[#0c0c0e] border-2 border-[#1f1f22] focus:border-purple-500/50 text-white rounded-xl shadow-inner placeholder:text-slate-600"
                value={query}
                onChange={(e) => setQuery(e.target.value)}
              />
              <div className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center gap-2">
                <kbd className="hidden sm:inline-flex px-2 py-1 items-center gap-1 rounded bg-[#1f1f22] text-[10px] font-mono text-slate-400 font-semibold border border-[#3f3f46]">
                  Ctrl K
                </kbd>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 min-h-[300px] bg-[#050505]">
            {/* Sidebar Filters */}
            <div className="col-span-1 border-r border-[#1f1f22] bg-[#0a0a0c] p-4 flex flex-col gap-4">
              <div>
                  ...
                  {['all', 'reddit', 'twitter', 'youtube', 'tiktok'].map(p => (
                    <button 
                      ...
                      className={`w-full text-left px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                        platform === p ? 'bg-purple-500/10 text-purple-400' : 'text-slate-400 hover:bg-[#1f1f22] hover:text-white'
                      }`}
                    >
              ...
              <div>
                ...
                <div className="space-y-2">
                  <label className="flex items-center gap-2 text-sm text-slate-300">
                    <input type="checkbox" className="rounded bg-[#141418] border-[#3f3f46] text-purple-500 focus:ring-purple-500" defaultChecked />
                    Include Sentiment
                  </label>
                  <label className="flex items-center gap-2 text-sm text-slate-300">
                    <input type="checkbox" className="rounded bg-[#141418] border-[#3f3f46] text-purple-500 focus:ring-purple-500" defaultChecked />
                ...
                <>
                  ...
                  <div className="grid gap-2">
                    {['Compare Marvel vs DC', 'Analyze Elden Ring demographic', 'Export Cyberpunk slide deck'].map(item => (
                      <div key={item} className="flex items-center px-3 py-3 text-sm text-slate-300 rounded-lg hover:bg-[#141418] hover:text-white cursor-pointer transition-colors border border-transparent hover:border-[#1f1f22]">
