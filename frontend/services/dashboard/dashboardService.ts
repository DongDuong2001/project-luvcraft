...
export interface DashboardData { trendData: TrendPoint[]; narrative: DashboardNarrative; collaboration: CollaborationCandidate[]; advancedInsights: AdvancedInsights; sourceConfidence: CrossSourceConfidence; geoRegions: GeoRegion[]; geoStatus: string | null; geoLocationConfidence: string | null; dimensions: InsightDimension[]; engagement: EngagementSummary | null; completedKeyword: string; }
